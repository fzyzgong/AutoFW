...
def get_TBS_token(mobile_id):
    ...
    handle = conn.cursor()
    username = handle.execute("select a.access_token from users_access_token a,users_info b where a.user_id=b.user_id and  b.mobile='%s' limit 1" % mobile_id)
...
if __name__ == "__main__":
    print (get_TBS_token('17607081946'))