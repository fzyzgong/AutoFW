...
class TestAPI:
    def testDemo(self, protocol, domian, url, headers, param, expected):
        ...
        try:
            ...
            mylogging("[" + str(__file__).split('/')[
                -1] + "][" + self.protocol + domian + url + "] <EXCEPTION>\r" + traceback.format_exc())
...
if __name__ == "__main__":
    ...
    url = "/subscribe/setSubsCancel"
    headers = ''
    param = 'house_id=18048&userid=444445209'
    expected = 0
