...
if __name__ == "__main__":
    protocol = "HTTPS"
    domian = "ta.2boss.cn"
    url = "/rabbit/v1/customer/house/search"
    headers = ''
    param = {"pageType":0,"pageSize":20,"targetId":0,"page":1,"lat":0.0,"type":3,"cityId":605,"lng":0.0,"keywords":"奉贤金汇"}
    expected = {"resultCode":0,"nearLocation":"null"}
